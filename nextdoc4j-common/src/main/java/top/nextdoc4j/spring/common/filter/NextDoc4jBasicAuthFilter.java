...
import top.nextdoc4j.spring.common.core.util.NextDoc4jLoginPageTemplate;
...
public class NextDoc4jBasicAuthFilter extends OncePerRequestFilter {
    ...
    /**
     * 从 resources 目录加载登录页面 HTML（模板渲染见 {@link NextDoc4jLoginPageTemplate}）。
     *
     * @return 登录页面 HTML 内容
     */
    private String loadLoginPageFromResources() {
        return NextDoc4jLoginPageTemplate.loadLoginPage(DOC_LOGIN, resourceLoader, nextDoc4JExtension, openAPI);
    }
}
