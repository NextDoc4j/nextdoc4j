...
import top.nextdoc4j.plugin.gateway.configuration.GatewayDocWebMvcConfigurer;
...
import top.nextdoc4j.plugin.gateway.filter.GatewayDocResponseRewriteFilter;
...
import top.nextdoc4j.plugin.gateway.provider.GatewayMvcRouteDefinitionLocator;
...
public class NextDoc4jGatewayWebMvcAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public WebMvcConfigurer gatewayDocWebMvcConfigurer() {
        return new GatewayDocWebMvcConfigurer();
    }
