...
public class NextDoc4jGatewayWebMvcAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public FilterRegistrationBean<GatewayDocResponseRewriteFilter> gatewayDocResponseRewriteFilterRegistration(GatewayDocProperties properties,
        ...
        registration.setFilter(new GatewayDocResponseRewriteFilter(properties, swaggerConfigCustomizerProvider));
