...
import top.nextdoc4j.gateway.webflux.filter.GatewayDocResponseRewriteWebFilter;
...
public class NextDoc4jGatewayAutoConfiguration {
    ...
    public GatewayDocResponseRewriteWebFilter gatewayDocResponseRewriteWebFilter(GatewayDocProperties properties,
        ...
        return new GatewayDocResponseRewriteWebFilter(properties, swaggerConfigCustomizerProvider);
    }
}
