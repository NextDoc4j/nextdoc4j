 ...
 */
package top.nextdoc4j.gateway.configuration;
...
public class NextDoc4jGatewayPropertiesConfiguration {
     ...
     */
    @Bean
    @ConditionalOnMissingBean(GatewayDocProperties.class)
