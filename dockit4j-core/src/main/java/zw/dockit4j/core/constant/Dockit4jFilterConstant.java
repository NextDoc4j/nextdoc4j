...
public class Dockit4jFilterConstant {
    ...
    public static final class BlockedPaths {
        ...
        public static final String DOCKIT4J_PREFIX = "/dk/";
        ...
        // 所有精确匹配的路径
        public static final String[] EXACT_PATHS = {DOCKIT_HTML, API_DOCS_YAML, API_DOCS, SWAGGER_UI_HTML,
            SWAGGER_RESOURCES};
        ...
        // 用于正则匹配的模式
        public static final String[] REGEX_PATTERNS = {"/dk/.*", "/v3/api-docs/.*", "/swagger-ui/.*",
