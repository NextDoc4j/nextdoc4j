 ...
 */
package top.nextdoc4j.security.satoken.customizer;
 ...
 * @since 1.2.0
 */
public class NextDoc4jSaTokenSecurityMetadataCustomizer implements GlobalOperationCustomizer, Ordered {

    private final List<NextDoc4jSecurityMetadataResolver> resolvers;

    public NextDoc4jSaTokenSecurityMetadataCustomizer(List<NextDoc4jSecurityMetadataResolver> resolvers) {
