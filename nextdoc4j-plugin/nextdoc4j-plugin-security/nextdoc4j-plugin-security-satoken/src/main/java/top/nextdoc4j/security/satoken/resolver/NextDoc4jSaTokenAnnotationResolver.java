...
public class NextDoc4jSaTokenAnnotationResolver implements NextDoc4jSecurityMetadataResolver {
    ...
    public boolean supports(Class<?> beanType, Method method) {
        return hasAnnotation(method
            .getAnnotation(NextDoc4jSaTokenConstant.SA_CHECK_PERMISSION_CLASS)) || hasAnnotation(method
                .getAnnotation(NextDoc4jSaTokenConstant.SA_CHECK_ROLE_CLASS)) || hasAnnotation(method
                    .getAnnotation(NextDoc4jSaTokenConstant.SA_IGNORE_CLASS)) || hasAnnotation(beanType
                        .getAnnotation(NextDoc4jSaTokenConstant.SA_CHECK_PERMISSION_CLASS)) || hasAnnotation(beanType
                            .getAnnotation(NextDoc4jSaTokenConstant.SA_CHECK_ROLE_CLASS)) || hasAnnotation(beanType
